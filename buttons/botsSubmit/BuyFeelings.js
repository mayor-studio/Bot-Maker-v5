  ...
  */
  async execute(interaction){
    if (interaction.isModalSubmit()) {
        if(interaction.customId == "BuyFeelings_Modal") {
            ...
            try{
              const owner = interaction.user.id
                let price1 = prices.get(`feelings_price_${interaction.guild.id}`) || 40;
                ...
                .addFields(
                    ...
                    {
                        name:`**نوع البوت**`,value:`**\`Feelings Bot\`**`,inline:false
                    },
                    {
                ...
                // Calculate newbalance here, before any embeds
                ...
                client24.on('ready', async() => {
                    ...
                    .setURL(`https://discord.com/api/oauth2/authorize?client_id=${client24.user.id}&permissions=8&scope=bot%20applications.commands`);
              ...
              .setURL('https://youtube.com/@3mran77'); // Replace with your YouTube channel
                ...
                let doneembedprove = new EmbedBuilder()
                    ...
                    .addFields(
                        ...
                        {name: 'نوع البوت', value: '`Feelings Bot`', inline: true},
            ...
            require("../../Bots/feelings/handlers/events")(client24)
            require("../../events/requireBots/feelings-commands")(client24);
            const folderPath = path.resolve(__dirname, '../../Bots/feelings/slashcommand24');
...
const folderPath3 = path.resolve(__dirname, '../../Bots/feelings/handlers');
 ...
 client24.on("interactionCreate", async (interaction) => {
  ...
  await interaction.update({ embeds: [embed], components: [row] });
            ...
            client24.on("ready" , async() => {
              ...
              const folderPath2 = path.resolve(__dirname, '../../Bots/feelings/events');
            ...
            for (let file of readdirSync(folderPath2).filter(f => f.endsWith('.js'))) {
                ...
                client24.on("interactionCreate" , async(interaction) => {
                  ...
                  if(!feelings) {
                      await tokens.set(`feelings` , [{token:Bot_token,prefix:Bot_prefix,clientId:client24.user.id,owner:interaction.user.id,timeleft:2629744}])
                  }else {
                      await tokens.push(`feelings` , {token:Bot_token,prefix:Bot_prefix,clientId:client24.user.id,owner:interaction.user.id,timeleft:2629744})
                  }
