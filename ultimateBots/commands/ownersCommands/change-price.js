...
const choices = [ 'apply', 'azkar', 'Broadcast', 'normalBroadcast', 'credit', 'tax', 'invites', 'verify', 'privateRooms', 'spin', 'Logs', 'giveaway', 'ticket', 'suggestions', 'system', 'shop', 'feedback', 'probot', 'protect', 'color', 'tempvoice', 'autoline', 'feelings', 'one4all', 'emoji', 'offers', 'games', 'nadeko', 'twitter', 'emoji', 'warn'];
