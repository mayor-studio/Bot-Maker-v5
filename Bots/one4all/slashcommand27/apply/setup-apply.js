...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    ...
    .addChannelOption((option) =>
      option
        .setName("applyroom")
        .setDescription("Channel for the application message")
        .setRequired(true)
    )
    .addChannelOption((option) =>
      option
    ...
    .addChannelOption((option) =>
      option
        .setName("resultsroom")
        .setDescription("Channel for sending application results")
        .setRequired(true)
    )
    .addRoleOption((option) =>
      option
        .setName("adminrole")
        .setDescription("Admin role that can manage applications")
        .setRequired(true)
    ),
