    ...
    async execute(interaction) {
        try {
            ...
            await interaction.reply({
                content: `✅ Bot username successfully changed to: **${newName}**`,
                ephemeral: true
            });
        } catch (error) {
            ...
            await interaction.reply({
                content: '❌ An error occurred while changing the username. Please try again later or ensure you are not rate-limited.',
                ephemeral: true
            });
        }
    }
