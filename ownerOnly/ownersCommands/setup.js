...
module.exports = {
    ...
    .setName('setup')
    .setDescription('Setup the maker system')
...
if(buybotroom) {
 ...
 await setting.set(`statusroom_${interaction.guild.id}` , statusroom.id);
    ...
    const theBots = [
        ...
        {
            name:`الرومات المؤقتة` , defaultPrice:15,tradeName:`tempvoice`
        },
        {
            name:`السحب`,defaultPrice:20,tradeName:`spin`
        },
        {
        ...
        {
            name:`الدعوات` , defaultPrice:15,tradeName:`invites`
        },
        {
        ...
        {
			name:`الالوان` , defaultPrice:25 , tradeName:`color`
		},
        {
            name:`التوثيق` , defaultPrice:15,tradeName:`verify`
        },
        {
